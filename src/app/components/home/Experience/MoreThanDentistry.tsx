...
import MODExperience from "@/../public/assets/images/MODExperience.png";

export default function MoreThanDentistryHome() {
	return (
		<>
							...
							<div className="relative lg:order-2">
								...
								<div className="relative">
									...
									<div className="relative z-10 rounded-lg overflow-hidden shadow-lg">
										<Image
											src={MODExperience || "/MODExperience.png"}
