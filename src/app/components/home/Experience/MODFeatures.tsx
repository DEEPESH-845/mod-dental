...
const features = [
	{
		...
		description:
			"Sit back and relax in our ergonomic, electronically adjustable chairs designed for total comfort.",
	},
	{
		icon: Coffee,
		title: "Beverage Bar Bliss",
		description:
			"Enjoy a warm cup of coffee or tea from our in-clinic beverage counter before your appointment.",
	},
	{
		icon: Lightbulb,
		title: "Mood Lighting Options",
		description:
			"Customizable lighting designed to match your mood and help you feel calm and at ease.",
	},
	{
		icon: Monitor,
		title: "Entertainment While You Wait",
		description:
			"Catch up on your favorite Netflix shows or calming videos while we prepare your treatment.",
	},
	{
		icon: Volume2,
		title: "Noise-Free Environment",
		description:
			"We maintain a peaceful, sound-controlled space to ease anxiety and enhance relaxation.",
	},
	{
		icon: Users,
		title: "Kid-Friendly Zone",
		description:
			"Dedicated play area and fun distractions to keep your little ones comfortable and engaged.",
	},
];
			...
			<div className="relative z-10 container mx-auto px-4">
				...
				<div className="text-center mb-12">
					<h2 className="text-4xl lg:text-5xl font-light text-[#2C4F3C] mb-4">
						Patient Centered.{" "}
						<span className="font-normal">Comfort Focused.</span>
					</h2>
					<p className="text-lg text-gray-600 max-w-3xl mx-auto">
						Innovative comforts that transform routine visits into extraordinary
						experiences.
					</p>
				</div>
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-3">
					{features.map((feature, index) => (
						...
						>
							...
							{/* Icon */}
							<div className="w-32 h-32 mx-auto mb-6 bg-[#2C4F3C14] rounded-full flex items-center justify-center">
