			...
			<div className="relative z-10">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-12">
						...
						<div
							className={
								"text-right font-[400]" + " " + libreBaskerville.className
							}
						>
					...
					<div className="mb-10">
						<div className="text-white">
							...
							<div className="flex items-center space-x-3">
								<svg className="w-14 h-13" viewBox="0 0 272 92" fill="none">
									<path
							...
							<div className="flex items-center space-x-3">
								...
								<span
									className={"text-base font-extralight " + inter.className}
								>
									108 Reviews
								</span>
							</div>
					...
					<div className="relative">
						...
						<div className="relative flex items-center justify-between">
							...
							<Button
								variant="outline"
								className={
									"bg-white border-white/30 hover:bg-dental-green hover:text-white p-6 text-base font-medium tracking-wide rounded-sm text-[#2C4F3C]" +
									" " +
									poppins.className
								}
							>
							...
							<div className="flex items-center space-x-2 bg-[#325240] rounded-2xl">
								<button
									onClick={prevSlide}
									className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white hover:text-black transition-colors duration-200"
