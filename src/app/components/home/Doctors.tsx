					...
					<div className="grid lg:grid-cols-3 gap-8 items-start">
						...
						<div className="space-y-6">
							...
							<div className="flex space-x-4">
								<button className="bg-[#2C4F3C] text-white px-6 py-3 font-medium rounded-md  flex items-center gap-2 whitespace-nowrap">
						...
						<div className="lg:col-span-1 space-y-12 text-gray-600 pt-16">
							<div>
								<h3 className="text-2xl text-[#4A7D5A] mb-2">
									{doctors[0].name}
								</h3>
								<p className="text-sm leading-relaxed">{doctors[0].bio}</p>
							</div>
							<div className="pt-12">
								<h3 className="text-2xl text-[#4A7D5A] mb-2 text-right">
									{doctors[1].name}
								</h3>
