  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 ">
      ...
      <div className="absolute inset-0 z-0">
        <video autoPlay loop preload="auto" muted className="w-full h-full object-cover">
      ...
      {/* Content */}
      <div className="relative z-10 text-bottom max-w-5xl mx-auto">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-white/90 mb-12 max-w-4xl mx-auto text-shadow-strong font-light leading-relaxed animate-slide-up">
          At Mod Dentist, we&apos;ve reimagined dental care around your comfort,
