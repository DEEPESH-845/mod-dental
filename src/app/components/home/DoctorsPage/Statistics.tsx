        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
          ...
          <div className="text-white space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            <h1 className="text-3xl mt-7 pt-7 sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-light leading-tight">
              <span className="text-dental-gold italic font-serif">Gentle</span>, Doctor-Led{' '}
            ...
            <p className="text-md pr-6 font-light opacity-90 text-center leading-relaxed max-w-2xl mx-auto">
              At MOD Dentist in Houston, our doctors believe in care that is as personal as your smile. With a gentle, minimally invasive approach, 
              they focus on your comfort, listen to your needs, and tailor every treatment to you—building trust one visit at a time.
            </p>

            {/* Statistics */}
            <div className="grid grid-cols-2 sm:grid-cols-2  pt-4 lg:pt-6">
              <div className="text-center sm:text-center">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl  font-light mb-1 pr-8 lg:mb-2">98%</div>
                <div className="text-xs sm:text-sm md:text-base lg:text-base font-light pr-10 opacity-90">Patient Satisfaction</div>
              </div>
              <div className="text-center sm:text-center">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl  font-light mb-1 pr-40 lg:mb-2">1200+</div>
                <div className="text-xs sm:text-sm md:text-base lg:text-base  font-light pr-42 opacity-90">Smiles Transformed</div>
              </div>
              <div className="text-center sm:text-center">
                <div className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl  font-light mb-1 pt-8 pl-54 lg:mb-2">15+</div>
                <div className="text-xs sm:text-sm md:text-base font-light pl-50 opacity-90">Years of Experience</div>
              </div>
          ...
          <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
            <div className="aspect-[4/3] bg-white rounded-lg overflow-hidden shadow-2xl">
              <Image
