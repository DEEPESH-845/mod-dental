			...
			<div className="flex flex-col lg:flex-row">
				...
				<div className="lg:w-1/2 bg-[#F3EFE9] p-6 sm:p-8 lg:p-12 xl:p-16 relative min-h-[600px] lg:min-h-screen">
					<div className="max-w-md">
						{/* Header */}
						<h1
							className={`text-4xl sm:text-5xl lg:text-6xl text-[#2C4F3C] mb-2 leading-tight`}
						>
							Get in Touch
						</h1>
						...
						<div className="space-y-8 lg:space-y-10">
							...
							<div>
								<h2
									className={`text-2xl lg:text-3xl  font-light text-[#2C4F3C] mb-1 italic font-serif`}
								>
									Phone
								</h2>
								...
								<a
									...
									className="text-lg underline decoration-[#BFB17E] text-[#BFB17E] text- hover:text-[#CA8A04] hover:decoration-[#CA8A04] transition-colors"
								>
									+1 (832) 762-5635
								</a>
							</div>
							...
							{/* Email Section */}
							<div>
								<h2 className="text-2xl lg:text-3xl font-light text-[#2C4F3C] mb-1 italic font-serif">
									Email
								</h2>
					...
					<div className="mt-14 lg:mt-0 lg:absolute lg:top-53 lg:left-80 xl:left-96 2xl:left-[420px]">
						<h2 className="text-2xl lg:text-3xl font-light text-[#2C4F3C] mb-4 lg:mb-6 italic font-serif">
							Hours
						</h2>
