			...
			<div className="relative z-10">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="relative">
						{/* Horizontal Line */}
						<div className="absolute top-1/2 left-0 right-0 w-[200vw] -ml-[50vw] -translate-x-1/2 h-px bg-[#B6A76A] transform -translate-y-1/2" style={{ left: '100%' }}></div>
						...
						<div className="relative flex items-center justify-between">
							...
							<Button
								variant="outline"
								className={"bg-white border-[#2C4F3C] hover:border-white text-[#2C4F3C] hover:bg-[#2C4F3C] hover:text-white p-6 text-base font-medium tracking-wide rounded-sm " + " " + poppins.className}
							>
								WRITE A REVIEW
							</Button>

							{/* Navigation Arrows */}
							<div className="flex items-center space-x-2 bg-[#2E513E] rounded-2xl">
								<button
									onClick={prevSlide}
									className="w-12 h-12 rounded-full bg-white/20 hover:bg-[#F3EFE9]  flex items-center justify-center text-white hover:text-black transition-colors duration-200"
